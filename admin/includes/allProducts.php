...
foreach($allProducts as $values){
                    ...
                    <a class="product-button" id="update-button" onclick="showUpForm()" >Update</a>
                    <a class="product-button" id="delete-button" onclick="deleteProduct('.$values['s-id'].')" href="#">Delete</a>
                    </div>
                    </div>';
                }
                ?>
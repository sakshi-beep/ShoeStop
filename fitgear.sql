...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 05:12 PM
...
INSERT INTO `customers` (`id`, `email`, `password`, `fullname`, `is_active`) VALUES
(1, 'sanjay1khadka@gmail.com', '1234567', 'sanjay khadka', 1),
(50, 'akritiadhiraki@gmail.com', '1234567', 'Akriti Adhikari', 0),
(53, 'peayushshrestha@gmail.com', '1234567', 'Peayush Shrestha', 0),
(54, 'pompousdahal@gmail.com', '1234567', 'Nischal Dahal', 1),
(55, 'bmochanb@gmail.com', 'bimochan07', 'Bimochan Bajimaya', 0),
(56, 'shushantadhungana0@gmail.com', 'y2u2j224', 'Shushanta Dhungana', 1);
...
INSERT INTO `orders` (`order_id`, `user_id`, `status`, `shipping_address`, `payment_method`, `total`, `is_active`) VALUES
(12, 1, 'pending', 'kathmandu', '', '2450.00', 0),
(13, 1, 'pending', 'kathmandu', 'khalti', '4740.00', 0),
(14, 1, 'pending', 'kathmandu', 'khalti', '9560.00', 1),
(15, 1, 'pending', 'kathmandu', 'khalti', '6520.00', 1),
(16, 56, 'pending', 'bouddha', 'khalti', '14999.00', 0),
(17, 56, 'pending', 'kkkkkkkkkkkkkkk', 'khalti', '2450.00', 0),
(18, 56, 'pending', 'Bode', 'khalti', '2450.00', 1),
(19, 56, 'pending', 'Boudha', 'khalti', '2450.00', 0),
(20, 56, 'pending', 'Boudha', 'khalti', '2450.00', 1);
...
(12, 15, 57, 2, '6520.00', 6),
(13, 16, 49, 1, '14999.00', 7),
(14, 17, 52, 1, '2450.00', 6),
(15, 18, 52, 1, '2450.00', 8),
(16, 19, 52, 1, '2450.00', 8),
(17, 20, 52, 1, '2450.00', 8);
...
(54, 'Club C 85 Vintage Shoes', 'casual', 43, 9560, 1, 12, 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c2hvZXN8ZW58MHx8MHx8fDA%3D', 1),
...
--
ALTER TABLE `shoes`
  MODIFY `s_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
